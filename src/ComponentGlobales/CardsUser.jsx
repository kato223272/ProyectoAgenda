...
export function CartaUsuario(Nombre_E, Nombre_Servicio, Localidad, Imagen_64, Descripcion, Num_Telf_E){
  return (
    <div className="fondoPrincipal">
      <Container>
        <Row className="justify-content-center">
          <Col xs={12}>
            <div className="fondoCard">
              <Row>
                <Col xs={12} md={6} className="d-flex justify-content-center align-items-center">
                  <Container className='d-flex justify-content-center align-items-center'>
                    <Image className="ImagenProvee" src={`data:image/jpeg;base64,${Imagen_64}`} rounded fluid />
                  </Container>
                </Col>
                <Col xs={12} md={6}>
                  <Card.Body>
                    ...
                    <Card.Subtitle id="especialidad" style={{
                      ...
                      fontSize: "1.2vw",
                      marginBottom: "5%"}}>
                      <FaInfo className="icono-especialidad" /> {Nombre_Servicio}
                    </Card.Subtitle>
                    <br />
                    <Card.Text style={{
                      display: "flex",
                      ...
                      marginBottom: "0.9vw",
                      fontSize:"110%"}}>
                      <FaUser className="icono-biografia" style={{fontSize: "1.5vw", marginRight:"2%"}} /> {Descripcion}
                    </Card.Text>
                    <Card.Text style={{
                      display: "flex",
                      alignItems: "center",
                      marginBottom: "0.9vw",
                      fontSize:"120%"}}>
                      <FaMapMarkerAlt className="icono-estado" style={{fontSize: "1.5vw", marginRight:"2%"}} /> {Localidad}
                    </Card.Text>
                    <div style={{
                      display: "flex",
                      alignItems: "center",
                      marginBottom: "0.9vw",
                      fontSize:"1.2vw"}}>
                      <FaPhoneAlt className="icono-telefono" style={{fontSize: "1.3vw", marginRight:"2%"}} /> {Num_Telf_E}
                    </div>
                    <div className="botones-separados">
                      <Button className="agendar" type="submit" href="/AgendarCita">
                        <FaCalendarPlus className="icono-agendar" /> Agendar
